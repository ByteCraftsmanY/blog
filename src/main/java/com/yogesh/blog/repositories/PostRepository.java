...
public interface PostRepository extends JpaRepository<Post, Integer> {
    ...
    Page<Post> findPostsByKeywordAndAuthorAndTagAndPublishedDateDuration(String keyword, String author, List<String> tags, LocalDateTime startDate, LocalDateTime endDate, Pageable pageable);
    ...
    Page<Post> findPostsByAuthorAndTagsAndPublishedDateDuration(String author, LocalDateTime startDateTime, LocalDateTime endDateTime, List<String> tags, Pageable pageable);
